  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16">
        <div className="page-padding-x">
          <div className="bg-blue-50 rounded-2xl p-8 max-w-6xl mx-auto">
            <div className="bg-white rounded-xl p-6 shadow-lg">
              {/* Mock UI */}
              <div className="border-b pb-4 mb-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-6">
                    <span className="font-bold text-gray-800">TikiAnaly</span>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button className="text-sm text-blue-600 font-medium">Sign In</button>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <div className="lg:col-span-1">
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h5 className="font-semibold text-gray-800 mb-3">Football</h5>
                    <div className="space-y-3">
                      <div className="text-sm text-gray-600">Popular leagues</div>
                ...
                <div className="lg:col-span-2">
                  <div className="space-y-4">
                    <div className="flex gap-2">
                      {['Football', 'Basketball', 'Tennis', 'eSport'].map((sport) => (
                        <button key={sport} className={`px-4 py-2 rounded-lg text-sm ${sport === 'Football' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-600'}`}>
                          {sport}
                        </button>
                      ))}
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-center gap-3">
                          <span className="text-sm font-medium">Manchester City</span>
                          <span className="text-sm text-gray-500">vs</span>
                          <span className="text-sm font-medium">Arsenal</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <span className="text-sm text-gray-500">2-1</span>
                ...
                <div className="lg:col-span-1">
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h5 className="font-semibold text-gray-800 mb-3">LATEST NEWS</h5>
                    <div className="space-y-3">
                      <div className="flex gap-2">
                        <div className="w-12 h-8 bg-gray-300 rounded"></div>
                        <div className="text-xs text-gray-600">Transfer news: Latest updates...</div>
                      </div>
                      <div className="flex gap-2">
                        <div className="w-12 h-8 bg-gray-300 rounded"></div>
                        <div className="text-xs text-gray-600">Match preview: Key players...</div>
                      </div>
                    </div>
                  </div>
                </div>
